...
export function TeamHeader({
  ...
  return (
    <header className="sui-mb-3 sui-flex sui-flex-col sui-gap-2 sui-justify-between md:sui-flex-row">
      <div>
        <h1 className="sui-heading-lg sui-mr-2 sui-font-medium sui-mb-2" data-testid="team-name-header">
          {teamName}
        </h1>
        <div className="sui-flex sui-gap-2">
          <Status state={statusStateMap[status]} text={statusLabelMap[status]} data-testid="team-status" />
