...
export default function ImportPracticesByCSVWizard() {
    ...
    <Dialog open={isOpen} onOpenChange={handleOnOpenChange}>
      <DialogTrigger asChild>
        <DropdownMenuItem
          ...
          data-testid="import-practices-csv-button"
        >
          <SimpleIcon name="upload" size="s" />
          Import practices by CSV
        </DropdownMenuItem>
      </DialogTrigger>
      <DialogContent size="lg">
        <DialogHeader>
          <DialogTitle>Import Practices by CSV</DialogTitle>
        </DialogHeader>
        <DialogBody>
          <p className="sui-body sui-mb-4">
            Upload a CSV file to import practices in bulk.
          </p>
          <div className="sui-flex sui-flex-col sui-gap-4">
            ...
            <div className="sui-bg-neutral-background-weak sui-rounded sui-p-3">
              ...
              <ul className="sui-body sui-list-disc sui-pl-4 sui-space-y-1">
                <li>Include columns: Date, Time, Team, Venue</li>
